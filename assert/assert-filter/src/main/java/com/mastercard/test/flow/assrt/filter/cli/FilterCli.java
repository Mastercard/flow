 ...
 * we run the tests. Crucially, we get the chance to choose tags before
 * transactions are built - this can improve performance by avoiding building
 * flows that will not be exercised.
 */
