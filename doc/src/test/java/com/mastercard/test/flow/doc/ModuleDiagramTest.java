...
/**
 * Ensures that the project diagram in the main readme accurately reflects the POM structure.
 * Spiders over the pom structure and regenerates the mermaid diagrams. These tests will fail if
 * that regeneration makes any changes. It should pass if you just run it again, but do be sure to
...
class ModuleDiagramTest {
	...
	/**
	 * Projects that aren't really interesting but that stink up the diagram with all their links
	 */
