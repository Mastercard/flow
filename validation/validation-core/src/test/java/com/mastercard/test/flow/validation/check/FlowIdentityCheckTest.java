...
/**
 * Exercises {@link FlowIdentityCheck}
 */
class FlowIdentityCheckTest extends AbstractValidationTest {

	/***/
	FlowIdentityCheckTest() {
		super( new FlowIdentityCheck(),
				"Flow Identity",
				"All flows in a model have a unique identity" );
	}
